    ...
    <>
      ...
      <div className="min-h-screen bg-background py-12 px-4 md:px-12">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 bg-gradient-primary bg-clip-text text-transparent">Orders</h1>
                  ...
                  <tbody className="bg-card divide-y divide-border">
                    {dummyOrders.map((order) => (
                      <tr key={order.id} className="hover:bg-muted/50 transition-smooth">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">{order.customer}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{order.date}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-foreground">{order.total}</td>
