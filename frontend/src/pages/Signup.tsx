      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="shadow-xl border-0 bg-background/95 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Join Nevyra and start shopping with exclusive benefits
            </CardDescription>
          </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                      <div className="flex items-center space-x-1">
                        <Check className={`h-3 w-3 ${formData.password.length >= 8 ? "text-green-600" : "text-muted-foreground"}`} />
                        <span>At least 8 characters</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <Check className={`h-3 w-3 ${/[a-z]/.test(formData.password) ? "text-green-600" : "text-muted-foreground"}`} />
                      ...
                      <div className="flex items-center space-x-1">
                        <Check className={`h-3 w-3 ${/[0-9]/.test(formData.password) ? "text-green-600" : "text-muted-foreground"}`} />
                        <span>Number</span>
                      </div>
                    </div>
                  </div>
